						...
						<div class="relative flex items-center justify-center min-h-screen-- bg-gray-1001 dark:bg-gray-9001 sm:items-center p-40">
							<form class="w-full max-w-sm" wire:submit.prevent="submit" enctype="multipart/form-data">
							  ...
							  <div class="md:flex md:items-center">
								...
								<div class="md:w-2/3">
								  <button wire:loading.class.remove="shadow bg-blue-500 hover:bg-blue-400"  wire:loading.class="bg-gray" class="shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">
									Upload
								  </button>
								</div>
							  </div>
