			...
			@endphp 
				...
				<a class="block p-4 bg-white rounded shadow-sm hover:shadow overflow-hidden">
					...
					<div class="flex justify-end">
					  <div><button wire:click="delete({{$media_id}})" type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete</button></div>
					</div>
				</a>
        @endforeach
		@endif
